  ...
  return (
    <nav className={`text-white z-40 w-full flex h-[55px] px-5 items-center justify-between font-montserrat border-gray-800 border-b-[1px] ${fixed?"fixed top-0 bg-black" :""}`}>
        <div className='w-[50%] flex items-center gap-5'>
            ...
            <div className='flex h-[35px] bg-[#393333] items-center w-[60%] px-2 rounded-md gap-1'>
                ...
                {suggestion[0]&&suggestionClicked&&<div ref={componentRef5} className='absolute top-16 py-2 max-h-[400px] overflow-y-scroll w-[500px] bg-[#393333]'>
                      {suggestion.map((s)=>(
        ...
        <div className='w-[50%] gap-8 flex items-center justify-end text-gray-400 '>
