...
const Feed = () => {
  ...
  return (
    <div className='w-full flex flex-col items-end font-sans'>
      <div className='w-[61%] flex border-gray-800 border-b-[1px] gap-3 font-semibold text-lg mb-5'>
        <Link className='h-10 border-solid border-blue-400 text-blue-400 border-b-2' href="/"><span className='px-5  '>For you</span></Link>
        <Link className='h-10' href="/"><span className='px-5'>Following</span></Link>
        <Link className='h-10' href="/"><span className='px-5'>Your tags</span></Link>
      </div>
    {
      data?.map(d=>(
